...
export default function ServiciosPage() {
  return (
    <div className="container mx-auto px-6 py-12 md:py-24">
      <h1 className="text-4xl font-bold tracking-tight sm:text-5xl mb-6">Servicios</h1>
      <p className="text-xl text-muted-foreground mb-12 max-w-3xl">
        Soluciones personalizadas para potenciar tu negocio y equipo comercial. Cada servicio está diseñado para
      ...
      <div className="mt-16 text-center">
        <h2 className="text-2xl font-bold mb-4">¿No estás seguro de qué servicio necesitás?</h2>
        <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
          Agendá una consulta gratuita para analizar tu situación y recomendarte la mejor solución para tus necesidades.
        </p>
