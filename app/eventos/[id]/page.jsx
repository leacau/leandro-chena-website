    ...
    return (
      <div className="container mx-auto py-12 px-4">
        <div className="max-w-4xl mx-auto">
          <Link href="/eventos" className="inline-flex items-center text-primary hover:underline mb-6">
          ...
          <div className="prose prose-lg max-w-none dark:prose-invert mb-8">
            ...
            {eventData.content && <div dangerouslySetInnerHTML={{ __html: eventData.content }} />}
          </div>
