  ...
  return (
    <div className="container mx-auto py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-3xl md:text-4xl font-bold mb-4">{safePost.title}</h1>
        ...
        {safePost.description && (
          <div className="text-lg font-medium mb-8 text-muted-foreground">{safePost.description}</div>
        )}
